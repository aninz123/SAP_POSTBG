...
int bl_sap_postbg_SQL_6_8()
{
	...
	try{
		...
		{
			int_V_ID1 = 1;
			int_V_ID2 = 3; //Chawalit C. #20190529
		}
		else
		{
			int_V_ID1 = 4;
 ...
 * Version 3.00.01  prissana.p     modify sap_postbg support billtype = 3  20190529
 ************************************************************************/
int main(int argc, char *argv[])
{
	...
	int_fwd_status = 0;
	 ...
	 int int_count=0;
		...
		#ifdef RBM_VERSION	
		sprintf(str_version, "%s.%s.%s", RBM_VERSION, SVN_REV, "3.00.01" );
		#else	
		sprintf(str_version, "%s", "3.00.01" );
		#endif
